...
/**
 * calefactor - cybercat5555
 * Created using Tabula 8.0.0
 */
@Environment(EnvType.CLIENT)
public class CalefactorEntityModel<T extends Entity> extends EntityModel<T> {
    ...
    public CalefactorEntityModel() {
        ...
        this.shield02.setPivot(-12.0F, 4.5F, 0.0F);
        ...
        this.shield01.setPivot(12.0F, 4.5F, 0.0F);
        ...
        this.shield03.setPivot(0.0F, 4.5F, -12.0F);
    ...
    public void render(MatrixStack matrixStackIn, VertexConsumer bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
        ImmutableList.of(this.shield03_1, this.rod05, this.head, this.rod06, this.rod08, this.shield02, this.shield01, this.rod03, this.rod04, this.rod01, this.crown, this.shield03, this.rod02, this.rod07).forEach((modelRenderer) -> { 
